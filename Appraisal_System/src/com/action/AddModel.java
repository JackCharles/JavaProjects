...
public class AddModel extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		boolean s = JdbcHelper.AddOrModifyModel(list, mid, name, "ADD");
		if (s)
		{
			out.println("<meta charset=\"utf-8\"><title>添加模板成功</title><p style=\"color:green\">☺");
			out.println("添加模板成功，返回即可可查看！</p>");
			out.println("<p><a href=\'addmodel.jsp\' title=\"返回\">点我继续添加</a></p>");
		}
		else
		{
			out.println("<meta charset=\"utf-8\"><title>错误</title><p style=\"color:red\">☹");
			out.println("添加模板失败，" + JdbcHelper.ErrorMsg[JdbcHelper.ErrorCode] + "</p>");
			out.println("<p><a href=\'addmodel.jsp\' title=\"返回\">点我重试</a></p>");
		}
	}
